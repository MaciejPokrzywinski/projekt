...
echo "<div class=\"text-center\">";
    echo "<h2>Twoje grupy</h2>";   
   echo "</div>"; 
 
    echo "<div class=\"text-center\">";
        echo "<select name=\"grupy\" style=\"width: 300px;\">";
...
echo "</div>";
    echo "<br>";
echo "<div class=\"text-center\">";
echo "<h2>Wprowadź nową nazwe grupy:</h2>";
echo "</div>";

    
echo "<div class=\"container\" style=\"width:300px;\">";
echo "<form action=\"edycja_grupy1.php\" method=\"POST\">";

echo "  <div class=\"form-group\">";
 echo "   <input type=\"text\" class=\"form-control\" name=\"nazwa_grupy\"; placeholder=\"Nowa nazwa\" required>";
 echo "   </div>";
...
echo "<br>";
echo "<div class=\"text-center\">";
echo "<button type=\"submit\" class=\"btn btn-success\">Zmień nazwę grupy</button>"; 
echo "</div>";
echo "</form>";
echo "</div>";
    echo "<br>";
echo "<div class=\"text-center\">";
if(isset($_COOKIE['zmiana_nazwy_grupy'])){
    echo $_COOKIE['zmiana_nazwy_grupy'];
    echo "</div>";
    echo "<br>";
}
?>
