...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
	...
	<div>
 <h2 class="text-center">Wybierz kontakt który chcesz edytować:</h2>
        <?php 
...
echo "<form action=\"edycja_numeru1.php\" method=\"POST\">";
   echo "<div class=\"text-center\">";
        echo "<select name=\"nazwa\" style=\"width: 300px;\">";
...
echo "<h2 class=\"text-center\">Wpisz dane które chcesz zmienić:</h2>";
echo "<div class=\"container\" style=\"width:300px;\">";   
echo "<form action=\"edycja_numeru1.php\" method=\"POST\">";

echo "<div class=\"form-group\">";
echo "<input type=\"text\" class=\"form-control\" name=\"nowe_imie\"; placeholder=\"Imię\" required>";
echo "</div>";
echo "<div class=\"form-group\">";
echo "<input type=\"text\" class=\"form-control\" name=\"nowe_nazwisko\" placeholder=\"Nazwisko\" required>";
echo "</div>";
echo "<div class=\"form-group\">";
echo "<input type=\"number\" class=\"form-control\" name=\"nowy_telefon\" placeholder=\"Numer\" required>";
echo "</div>";

echo "<div class=\"text-center\">";
echo "<button type=\"submit\" class=\"btn btn-success\">Zapisz zmiany</button>";
echo "</div>";
echo "</form>";
echo "</div>";
echo "<br>";
...
echo "<div class=\"text-center\">";
if(isset($_COOKIE['edycja_kontaktu'])){
    echo $_COOKIE['edycja_kontaktu'];
    echo "<br>";
}
echo "<div>";
echo "<br>";
