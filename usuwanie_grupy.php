...
echo "<div id=\"form\">";       
echo "<span style=\"text-align: center;\"><h2>Wybierz grupę którą chcesz usunąć:</h2></span>";        
        
        
echo "<form action=\"usuwanie_grupy1.php\" method=\"POST\">";
...
echo "<br>";
echo "<br>";
echo "<button type=\"submit\" class=\"btn btn-danger\" style=\"width: 150px;\">Usuń</button>";    
       echo "</form>";
    echo "<br>";
if(isset($_COOKIE['usuwanie_grupy'])){
    echo $_COOKIE['usuwanie_grupy'];
    echo "<br>";
    echo "</div>";
}
?>
