...
echo "wpisz dane które chcesz zmienić:<br>";
echo "<input type=\"text\" placeholder=\"Imie\" name=\"nowe_imie\" ><br>";
echo "<input type=\"text\" placeholder=\"Nazwisko\" name=\"nowe_nazwisko\"><br>";
echo "<input type=\"text\" placeholder=\"Numer\" name=\"nowy_telefon\"><br>"; 
